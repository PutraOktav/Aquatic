            ...
            <div class="p-6 bg-gray-100 border-b border-gray-300">
                <div class="space-y-6">
                    ...
                    <div class="bg-white shadow-md rounded-lg p-6">
                        <h2 class="text-xl font-semibold mb-4">Add New Medicine Stock</h2>
                        <form wire:submit.prevent="store">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div class="flex items-center">
                                    <label for="name" class="mr-2 text-lg">Name:</label>
                                    <input type="text" id="name" wire:model="name" placeholder="Enter Medicine Name"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input type="number" id="stock" wire:model="stock" placeholder="Stock Amount"
                                        class="border rounded-md px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    @error('stock')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                    ...
                    <div class="bg-white shadow-md rounded-lg p-4">
                        <h1 class="text-2xl font-semibold mb-4">List of Medicine Stocks</h1>
